...
# 文档配置
DOCUMENTS = {
    1: {'name': '企业级AI平台资源包预算测算说明', 'file': '01_预算测算说明.md'},
    2: {'name': '企业级AI平台预算汇报', 'file': '02_预算汇报.md'},
    3: {'name': '企业级AI平台供应商询价报告', 'file': '03_供应商询价.md'},
    4: {'name': '企业级AI平台席位费预算测算说明', 'file': '04_席位费预算测算说明.md'},
}
